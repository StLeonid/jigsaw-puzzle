...
public class BoardGen : MonoBehaviour
{
    ...
    public static GameObject CreateGameObjectFromTile(Tile tile)
    {
        ...
        obj.transform.GetComponent<RectTransform>().position = new Vector3(tile.xIndex * Tile.tileSize, tile.yIndex * Tile.tileSize, 0.0f);
        ...
        obj.GetComponent<Image>().sprite = Sprite.Create(tile.finalCut,
        new Rect(0, 0, Tile.padding * 2 + Tile.tileSize, Tile.padding * 2 + Tile.tileSize),
        new Vector2(0, 0),
        1.0f,
        0,
